  ...
  return (
    <div className="pb-0">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 md:px-12 overflow-hidden bg-sand-50">
        ...
        <div className="absolute bottom-8 left-6 md:left-12 z-10 flex items-center">
          <a 
            href="https://share.google/WpeMUhrLfkmNgO21S"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-black/35 backdrop-blur-md border border-white/15 hover:bg-black/50 hover:border-white/25 transition-all duration-300 group cursor-pointer shadow-lg"
          >
            <div className="w-8 h-8 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-white/15 transition-colors">
            ...
            <div className="flex flex-col gap-0.5">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-white tracking-wide">4.6 / 5</span>
              ...
              <span className="text-[10px] uppercase tracking-[0.12em] font-sans text-sand-200 group-hover:text-white transition-colors">
                Google Reviews
              </span>
            </div>
          </a>
